  ...
  return (
    <>
      <Show when={props.footer?.showFooter === undefined || props.footer?.showFooter === null || props.footer?.showFooter === true}>
        ...
        >
          {props.footer?.text ?? 'AI can make mistakes, always double-check.'}
          <a
            ref={liteBadge}
            href={props.footer?.companyLink ?? 'mailto:mail.rps.active@proton.me'}
            target="_blank"
          ...
          >
            <span>&nbsp;{props.footer?.company ?? ' Contact Us'}</span>
          </a>
        </span>
      </Show>
